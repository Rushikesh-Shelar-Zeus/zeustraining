...
export class Renderer {
     ...
     */
    constructor(options, ctx, columnWidths, rowHeights, grid) {
     ...
     */
    getDynamicHeaderWidth(viewPort) {
    ...
    */
     ...
     * @returns {void}
     */
    renderHeaderGridLines(viewPort) {
        const dynamicHeaderWidth = this.getDynamicHeaderWidth(viewPort);
        this.ctx.lineWidth = CONFIG.lineWidth;
