 ...
 */
export class TopLeftCellHitTestHandler implements HitTestHandler {
    /**
 ...
 * @implements {HitTestHandler}
 */
export class RowHitTestHandler implements HitTestHandler {
 ...
 * @implements {HitTestHandler}
 */
export class ColumnHeaderHitTestHandler implements HitTestHandler {
    /**
