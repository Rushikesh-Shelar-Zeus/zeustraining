...
export function attachPointerEvents(
    ...
    scrollContainer.addEventListener("pointerdown", (e: PointerEvent) => {
        e.preventDefault();
        isDragging = true;
    ...
    scrollContainer.addEventListener("pointermove", (e: PointerEvent) => {
    ...
    scrollContainer.addEventListener("pointerup", (e: PointerEvent) => {
        if (!isDragging) return;
