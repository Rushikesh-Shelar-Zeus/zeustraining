...
export class Renderer {
    ...
    private renderHeaders(colWidths: number[], rowHeights: number[], options: GridOptions, viewport: Viewport) {
    ...
    private renderBody(colWidths: number[], rowHeights: number[], options: GridOptions, viewport: Viewport) {
        let y = options.headerHeight - viewport.scrollY;
        for (let row = 0; row < rowHeights.length && y < viewport.height; row++) {
